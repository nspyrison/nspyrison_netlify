...
df_agg1 <- tibble(
  ...
  likes = 194,
  comments = 143,
  friends = 9 # EJ, Echo, Lance, Cerie, Deej, Yan, Dee, Cermi, Fernando
)

message("IFF proxy BLOWS 1Mx auth, cannot copy to/from desktop")
df_post <- tribble(
  ~comment, #~is_f, ~is_m, ~is_both, ~is_implicit, ~n_likes, ~n_replies, ~is_emoji, ~n_emoji
  "test",
  "foo"
)
```
...
TODO: Continue with the below or deprecate
