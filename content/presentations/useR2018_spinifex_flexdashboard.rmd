---
title: "spinifex: Visualizing local structure of high dim data"
...
knitr::include_graphics("./useR2018_images/QR_spinifex_useR2018.png")
```
...
#        width = 600, height = 600, "png", "./useR2018_images/fleaHolesTour-%03d.png")
# 
# browseURL("http://gifmaker.me/")
```
```{r, results="hold"}
knitr::include_graphics("./useR2018_images/FleaHolesTour.gif")
```
...
#        "png", "./useR2018_images/fleaHolesTour_groupxy-%03d.png")
# 
# #density_2d
# require(MASS)
# render(f, frames = 240, planned_tour(f.holes), #grand_tour(),
...
#                        group_by = flea$species, gp_legend = T),
#        width = 600, height = 600,
#        "png", "./useR2018_images/fleaHolesTour_density2d-%03d.png")
# 
# browseURL("http://gifmaker.me/")
```
...
```{r, results="hold"}
knitr::include_graphics("./useR2018_images/FleaHolesTour_groupxy.gif")
```

#### animate_density2d()

```{r, results="hold"}
knitr::include_graphics("./useR2018_images/FleaHolesTour_density2d.gif")
```
